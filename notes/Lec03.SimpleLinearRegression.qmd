...
-   The simple regression model produces an easy to remember (but
    ...
    -   Data were generated using this model (estimates, below, will be
        different)
...
| $\hat{\beta}$ | $\hat {\t extrm{Var}}_ { N R}(\hat{\beta})$ | $\hat {\textrm{Var } } _R(\hat{\beta})$ |
|---------------|---------------------------------------------|-----------------------------------------|
| Y             | Y                                           | Y                                       |
| Y             | M^2^                                        | M^2^                                    |
| Y             | N                                           | Y                                       |
...
```
+-------------+-------------+-------------+-------------+-------------+
| Model       | C lassical  | Robust I    | C lassical  | Robust \|   |
|             | I ntercept  | ntercept    | Slope       | Slope       |
+=============+=============+=============+=============+=============+
| Age - Ch o  |             |             |             |             |
| lesterol    |             |             |             |             |
|             |             |             |             |             |
