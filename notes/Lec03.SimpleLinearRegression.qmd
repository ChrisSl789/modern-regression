...
-   Many statistical problems examine the association between two variables
    ...
    -   (While "dependent variable" and "independent variable" are commonly used, these imply that a modifiable independent variable is _causing_ a dependent variable to change.  We are fitting models focused on association, not causation.)
