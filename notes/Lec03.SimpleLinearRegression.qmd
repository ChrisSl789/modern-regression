...
difference in age, the difference in mean cholesterol is 0.32 mg/dL. A
...
in age were between 0.05 and 0.59 mg/dL. Because $p = 0.02$, we reject
...
-   Response
    ...
    -   Notation: It is extremely common to use $Y$ to denote the
...
-   Valid statistical inference (CIs, p-values) about *mean responses
...
+----------------+---------------------------+------------------------+
| $\hat{\beta}$  | $\hat{\textrm             | $\hat{\textrm{         |
|                | {Var}}_{NR}(\hat{\beta})$ | Var}}_R(\hat{\beta})$  |
+================+===========================+========================+
| Y              | Y                         | Y                      |
+----------------+---------------------------+------------------------+
| Y              | M^2^                      | M^2^                   |
