...
-   The association between age and probability of survival was
    ...
    distribution for the log odds of survival given age (Normal prior
    with mean 0 and scale 0.17 for $\beta_1$). Conditional on the data,
    the posterior mean estimate indicates that comparing two subjects
    who differ in age by 5 years, the younger subject has a 1.04 fold
    increased odds of survival compared to the older subject. A 95%
    credible for this posterior odds ratio is from 1.00 to 1.09.
