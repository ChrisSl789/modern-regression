...
Comparing females to males, females have a 0.59 fold hazard (risk) of death compared to males. We are 95% confident the true hazard ratio is between a 0.43 and 0.82 fold increase. Since the hazard ratio does not contain 1, females are at a significantly decreased hazard of death compared to females.

Comparing females to males, females have a median (or any other quantile) survival times that is 1.49 times the median (or other quantile) survival time in males. We are 95% confident that the true acceleration factor is between 1.16 and 1.91.
