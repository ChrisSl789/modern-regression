...
-   [Brightspace](https://brightspace.vanderbilt.edu)
    ...
    -   Announcements
    -   Submit homework and manage grades
    -   FERPA compliance
...
-   Course notes rendered using Quarto with R code integrated
    ...
    -   I am still learning Quarto and it is evolving, so it has more features than I will likely use
-   Quarto introduction covered tomorrow
...
-   See syllabus for complete statement on the permitted uses of generative AI in this course
-   If any questions, ask the instructor for clarifications
-   As with any tool, use with caution
    -   Help with generating code, or converting code between languages
    -   Help with editing interpretations in more easily understood language
...
-   Rapidly evolving with many potential applications
-   Best used when you are the expert and AI is the assistant
    - If prompted correctly, AI can help you think through a problem, but you have to know the right prompts to use and evaluate critically
    - "Is my regression model good" vs "I am concerned about heteroskedasticity in my linear regression model. What diagnostic tests and remedies should I consider? What are the problems with using a p-value to test for heteroskedasticity like you said to do?"
   
-   We work with highly confidential data in Biostatistics
    -   Never upload data to AI platforms
    
## Key limitations of AI
-   **No true uncertainty quantification.** Generated text is confidently stated as being accurate.

-   **Training data is a frozen snapshot.** Models do not learn new information after training.

-   **No reasoning from first principles for complex problems.** Pattern recognition provides median responses.

-   **AI lowers barriers to performing analysis, but doing the right analysis remains complex.**

    -   This course is designed to build foundation for right-tail analytical ability - understanding *why* methods work and when standard approaches fail.

## Key skills for effective statistical practice (essential foundations for AI use)
-   **Specification**: Translating scientific questions into appropriate statistical approaches

-   **Verification**: Recognizing when output is wrong or incomplete, knowing what diagnostics to check

-   **Assumption evaluation**: Judging whether a method is appropriate given study design

-   **Interpretation**: Understanding what results mean in scientific context

-   In this course, assignments will systematically build these fundamental skills, positioning you as the expert in evaluating and improving AI-generated outputs

## AI collapse
- AI "thinks" differently than people do. Iteration often makes things worse, unlike human refinement.
